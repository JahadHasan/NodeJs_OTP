...
*/
    ...
    console.log(
      `https://bms.syriatel.sy/API/SendTemplateSMS.aspx?user_name=BRANDROOM1password=P@123456&template_code=BRANDROOM1_T1&param_list=${otpMessage}&sender=BRANDROOM&to=${myNewString}`
    );
