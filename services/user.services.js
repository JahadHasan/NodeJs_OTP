...
async function createNewOTP(params, callback) {
    ...
    console.log(`OTP is ${otp}. expires in 15 minutes, your mobile is ${myNewString}`);
    ...
    let url = axios.get(`http://www.ciedco-sms.net/api/sendsms.php?username=souhailsawaf@gmail.com&password=1234567890a&mno=${myNewString}&msg=${otpMessage}&sid=ciedco-sms&fl=0&mt=0`)
